/*!******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/next/dist/build/webpack/loaders/css-loader/src/index.js??ruleSet[1].rules[13].oneOf[12].use[2]!./node_modules/next/dist/build/webpack/loaders/postcss-loader/src/index.js??ruleSet[1].rules[13].oneOf[12].use[3]!./node_modules/react-perfect-scrollbar/dist/css/styles.css ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************/
/*
 * Container style
 */
...
#__next :is(.self-start) {
  align-self: flex-start;
}
#__next :is(.overflow-y-auto) {
  overflow-y: auto;
}
#__next :is(.overflow-x-hidden) {
  overflow-x: hidden;
}
#__next :is(.rounded) {
...
#__next :is(.text-error) {
  color: var(--mui-palette-error-main);
}
#__next :is(.text-primary) {
  color: var(--primary-color);
}
#__next :is(.text-textPrimary) {
  color: var(--mui-palette-text-primary);
}
#__next :is(.text-textSecondary) {
...
#__next :is(.min-bs-\[100dvh\]) {
  min-block-size: 100dvh;
}
#__next :is(.min-bs-full) {
  min-block-size: 100%;
}
#__next :is(.is-10) {
  inline-size: 2.5rem;
...
#__next :is(.min-is-\[160px\]) {
  min-inline-size: 160px;
}
#__next :is(.min-is-\[240px\]) {
...
@media (min-width: 600px) {
  ...
  #__next :is(.sm\:is-\[450px\]) {
    inline-size: 450px;
  }
  #__next :is(.sm\:is-\[unset\]) {
    inline-size: unset;
  }
}

@media (min-width: 900px) {
  #__next :is(.md\:bs-\[450px\]) {
    block-size: 450px;
  }
  #__next :is(.md\:mbs-14) {
